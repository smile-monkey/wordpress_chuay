...
/*  piklist('field', array(
    'type' => 'select'
    ,'field' => 'srtfile'
    ,'label' => esc_html__('SRT File','musik')
    ,'description' => esc_html__('Is SRT File?','musik')
    ,'choices' => array(
      'yes' => 'Yes'
      ,'no' => 'No'
    )
  ...
  piklist('field', array(
    'type' => 'textarea'
    ,'field' => 'lyrics1'
    ,'label' => esc_html__('Lyrics 1','musik')
    ,'attributes' => array(
      'rows' => 10
	  ,'cols' => 50
	  ,'class' => 'large-text'
  ...
  /*svnlabs*/
    ...
    'type' => 'textarea'
    ,'field' => 'lyrics2'
    ,'label' => esc_html__('Lyrics 2','musik')
    ,'attributes' => array(
	  'rows' => 10
	  ,'cols' => 50
      ,'class' => 'large-text'
  ...
  /*piklist('field', array(
    'type' => 'file'
    ,'field' => 'lyrics1file'
    ,'label' => esc_html__('Lyrics 1 SRT','musik')
    ,'attributes' => array(
      'rows' => 10
	  ,'cols' => 50
	  ,'class' => 'large-text'
    ...
    'type' => 'file'
    ,'field' => 'lyrics2file'
    ,'label' => esc_html__('Lyrics 2 SRT','musik')
    ,'attributes' => array(
	  'rows' => 10
	  ,'cols' => 50
      ,'class' => 'large-text'
