...
function musik_scripts() {
	...
	wp_enqueue_script('jplayer', get_template_directory_uri() . '/assets/js/jPlayer/jquery.jplayer.js?rand='.rand(10,1000), array('jquery'), '', true );  //svnlabs
	...
	wp_enqueue_script('player',   get_template_directory_uri() . '/assets/js/player.js?rand='.rand(10,1000), array('jquery'), '', true );  //svnlabs
