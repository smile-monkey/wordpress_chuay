		...
		_addHtmlEventListeners: function(mediaElement, entity) {
			...
			mediaElement.addEventListener("play", function() {
				if(entity.gate) {
					...
					// svnlabs 19 jun 2017
					console.log( "Setting Speed: "+speeds[currentSpeedIdx] );
			...
			mediaElement.addEventListener("ended", function() {
                ...
                /* 27 Oct 2017 Close Lyrics Window on Song End */
                jQuery('#current_playlist').slideUp();
		...
		_updateButtons: function(playing) {
			...
			if(this.css.jq.play.length && this.css.jq.pause.length) {
				if(playing) {
					...
					jQuery('#current_playlist').slideDown(); //svnlabs	
                    
                    // Font Memory 5 oct 2017 svnlabs 
					...
					//jQuery('#current_playlist').slideUp(); //svnlabs	   //// 19 jun 2017
