...
class Piklist_Admin
{
  ...
  public static function init()
  {
    ...
    if ($data['version'])
    {
      //self::check_update('piklist/piklist.php', $data['version']);  // svnlabs
    }

    //self::check_persistant_update();  // svnlabs

    //add_action('in_plugin_update_message-piklist/piklist.php', array('piklist_admin', 'update_available'), null, 2);  // svnlabs
  }
